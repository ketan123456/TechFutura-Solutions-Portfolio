          ...
          <div className="row g-4 align-items-stretch">
            ...
            <div className="col-md-6" data-aos="fade-left">
              <div className="card border-0 shadow-lg rounded-4 h-100 p-4 bg-white">
                ...
                <p className="text-muted">
                  Consciousroot is a comprehensive e-commerce platform designed
                  to streamline online shopping for various user personas
                  including end users, admins, affiliates, vendors, and
                  shopkeepers. The platform offers a seamless shopping
                  experience with features like product browsing, secure
                  payments, order tracking, and personalized recommendations.
                  Admins can efficiently manage products, orders, and users
                  through a dedicated dashboard, while vendors and shopkeepers
                  have specialized portals to handle their operations.
                  Consciousroot aims to create a unified ecosystem that enhances
            ...
            <div className="col-md-6" data-aos="fade-left">
              <div className="card border-0 shadow-lg rounded-4 h-100 p-4 bg-white">
                ...
                <ul className="list-unstyled small">
                  ...
                  <li className="mb-2">
                    Developed an admin dashboard that allows real-time tracking
                    of inventory levels and sales data, streamlining operations.
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="container" data-aos="fade-up">
          ...
          <div className="row g-4 align-items-stretch">
            ...
            <div className="col-md-6 col-lg-4" data-aos="fade-right">
              <div className="card border-0 shadow-lg rounded-4 h-100 p-4 bg-white bg-opacity-75 backdrop-blur">
                <h4 className="fw-bold text-primary mb-3">Ecommerce</h4>
                <p className="small mb-0">
                  Consumers can easily order and return their products. They can
                  add products to a wishlist to purchase later, choose their
                  preferred payment mode, and view personalized recommendations
            ...
            <div className="col-md-6 col-lg-4" data-aos="fade-up">
              <div className="card border-0 shadow-lg rounded-4 h-100 p-4 bg-white">
                ...
                <p className="small mb-0">
                  Admins can manage products, categories, orders, and users, and
                  view detailed sales reports. They can also create offers and
            ...
            <div className="col-md-6 col-lg-4" data-aos="fade-left">
              <div className="card border-0 shadow-lg rounded-4 h-100 p-4 bg-white bg-opacity-75 backdrop-blur">
                <h4 className="fw-bold text-primary mb-3">Affiliate System</h4>
                <p className="small mb-0">
                  Affiliates can promote products and earn commissions for each
                  sale generated through their unique referral links.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-6 col-lg-4" data-aos="fade-right">
              <div className="card border-0 shadow-lg rounded-4 h-100 p-4 bg-white">
                <h4 className="fw-bold text-primary mb-3">Vendor Management</h4>
                <p className="small mb-0">
                  Vendors can manage product listings, track orders, and monitor
                  sales performance through a dedicated vendor dashboard.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-6 col-lg-4" data-aos="fade-left">
              <div className="card border-0 shadow-lg rounded-4 h-100 p-4 bg-white bg-opacity-75 backdrop-blur">
                <h4 className="fw-bold text-primary mb-3">Shopkeeper Portal</h4>
                <p className="small mb-0">
                  Shopkeepers can manage stock, process orders, and access
                  real-time sales insights through a specialized portal.
                </p>
              </div>
            </div>
          </div>
